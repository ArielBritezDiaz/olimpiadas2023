...
<body>
    ...
    <form action="" method="POST">
        ...
        <select name="obra_social" id="obra_social" onchange="mostrarInputHidden()" required>
    ...
    <script>
        function mostrarInputHidden() {
            ...
            if(opcion == "Si") {
                ...
                obraSocialHidden.innerHTML = `<input type="text" name="nombre_obra_social" placeholder="Obra social">s</input>`;
            } else if(opcion == "No") {
                obraSocialHidden = ``;
            }
        }
