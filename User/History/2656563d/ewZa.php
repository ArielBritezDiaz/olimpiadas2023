...
<body>
    ...
    <form action="" method="POST">
        ...
        <select name="obra_social" onchange="mostrarInputHidden()" required>
            <option disabled selected>¿Obra social?</option>
            <option value="No">No</option>
            <option value="Si">Si</option>
        </select>
        <div class="obra_social_hidden"></div>
        ...
        <input type="text" name="nombre_medicamento" placeholder="¿Cual medicamento?">
    ...
    <script>
        function mostrarInputHidden() {
            const obraSocial = document.getElementById('');
            const opcion = obraSocial.value;

            if(opcion == "Si") {
                const obraSocialHidden = document.getElementById('obra_social_hidden');
                obraSocialHidden.innerHTML = `<input type="text" name="nombre_obra_social" placeholder="Obra social"></input>`;
            } else if(opcion == "No") {
                obraSocialHidden = ``;
            }
        }
